...
When `reporting a bug <https://github.com/vltr/xrtr/issues>`_ please include:
...
1. Fork `xrtr <https://github.com/vltr/xrtr>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/vltr/xrtr/pull_requests>`_ for each change you add in the pull request.
